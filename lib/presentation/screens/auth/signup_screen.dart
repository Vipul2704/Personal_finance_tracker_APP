...
class _SignupScreenState extends State<SignupScreen> {
  ...
  Future<void> _handleSignup() async {
    print('DEBUG: _handleSignup started');
    ...
    try {
      print('DEBUG: Calling authProvider.signUp()');
      ...
      print('DEBUG: signUp returned: $success');
      ...
      if (success) {
        print('DEBUG: Signup successful, clearing form');
        // Clear form fields
        ...
        print('DEBUG: Signup failed: ${authProvider.errorMessage}');
        _showSnackBar(
      ...
      print('DEBUG: Exception in _handleSignup: $e');
